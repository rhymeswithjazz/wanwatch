...
export default function SpeedTestError({
  error,
  reset,
}: {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      <div className="bg-destructive/10 border border-destructive/20 text-destructive p-8 rounded-lg">
        <h2 className="text-2xl font-bold mb-3">Failed to load speed tests</h2>
        <p className="mb-2 text-destructive/90">
          Unable to load speed test data. Please try again.
        </p>
        {error.message && (
